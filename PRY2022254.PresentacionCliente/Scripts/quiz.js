...
function mostrarReglas(event) {
    event.preventDefault();
    const botonEmpezar = document.getElementById("empezar");
    const regla = document.getElementById("reglas");

    botonEmpezar.style.display = "none";
    regla.removeAttribute("hidden");
}

function mostrarPreguntas(event) {
    event.preventDefault();
    document.getElementById("reglas").hidden = true;
    document.getElementById("prg_rpta").hidden = false;
}

function mostrarAtras(event) {
    event.preventDefault();
